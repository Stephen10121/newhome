...
<div class="absolute -top-10 -right-10 w-24 h-24 border border-primary/20 rounded-lg backdrop-blur-xl rotate-12 flex items-center justify-center transition-transform duration-500 group-hover:rotate-45">
